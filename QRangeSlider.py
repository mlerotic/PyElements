...
class Element(QtWidgets.QGroupBox):
    ...
    def textColor(self):
        return getattr(self, '__textColor', QtGui.QColor('#cbcac9'))
...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self, parent=None):
        ...
        self.handle.setTextColor((90, 88, 86))
    ...
    def _valueToPos(self, value):
        return scale(value, (self.min(), self.max()), (0, self.width()-8))

    def _posToValue(self, xpos):
        return scale(xpos, (0, self.width()-8), (self.min(), self.max()))
...
if __name__ == '__main__':
    ...
    #rs.handle.setStyleSheet('background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #fefefe, stop:1 #c9ccd4);')
    app.exec_()